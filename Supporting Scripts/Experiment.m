...
function Experiment(Parameters)
    ...
    for block_idx = 1:num_blocks
        ...
        [button_scores, block_change_logs] = GetScores(length(Parameters.target.button_names), ...  % The scores for each button
        ...
        score_change_logs.(['b', combos(block_idx,:)]) = block_change_logs;
    end
    
    % Save the experiment results
    save("All_Blocks.mat", "pl_choices", "pl_scores", "pl_times", "cpu_scores", "score_change_logs", ...
         "cpu_choices", "pl_totals", "cpu_totals", "exp_events", "combo_logs", "-mat");
