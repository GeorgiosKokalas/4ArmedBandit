...
function [player_avatar] = Introduction(Screen_Pars, Text_Pars, Targ_Pars)
    ...
    greeting_message = ['Hello, welcome to the multi armed bandit task.\n',...
                        'Your goal is to select the buttons that yield the maximum points.\n',...
                        'The 4 buttons are mapped to the four buttons of your controller.\n', ...
                        'One of these choices will be grayed out and unavailable.\n',...
                        'NOTE: Points yielded by any button CAN change over time.\n\n\n',...
                        'You will be playing against 1 player at a time.\n', ...
                        'You can maximize your own score by observing their playstyle.\n\n\n', ...
    ...
    while true
        ...
        try
            ...
            left_cond = pl_i.DPadLeft || (pl_i.JoystickRX < -0.5 && abs(pl_i.JoystickRY) < 0.5) ||...
                (pl_i.JoystickLX < -0.5 && abs(pl_i.JoystickLY) < 0.5);
            disp([down_cond, up_cond, left_cond,right_cond])
